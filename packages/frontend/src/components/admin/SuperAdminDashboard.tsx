          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] px-4 py-2 hover:border-[var(--accent)]"
              >
              ...
              {menuOpen && (
                ...
                >
                  <button
                    ...
                    className="w-full px-4 py-3 text-left text-text-secondary hover:bg-[var(--bg-subtle)] transition-colors flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 text-left text-red-400 hover:bg-[var(--bg-subtle)] transition-colors flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
